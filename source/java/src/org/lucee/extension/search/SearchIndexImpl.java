...
public final class SearchIndexImpl implements SearchIndex {
     ...
     * @param custom4 
     */
    protected SearchIndexImpl(String title, String key, short type, String query, String[] extensions,
            String language, String urlpath,String categoryTree, String[] categories, String custom1, String custom2, String custom3, String custom4) {
    	engine=CFMLEngineFactory.getInstance();
    ...
    public String toString() {
        return "lucee.runtime.search.SearchIndex(id:"+id+";title:"+title+";key:"+key+";type:"+toStringTypeEL(type)+
        ";language:"+language+";urlpath:"+urlpath+";query:"+query+";categoryTree:"+categoryTree+";categories:"+engine.getListUtil().toList(categories,",")+";custom1:"+custom1+";custom2:"+custom2+";custom3:"+custom3+";custom4:"+custom4+";)";
    }
