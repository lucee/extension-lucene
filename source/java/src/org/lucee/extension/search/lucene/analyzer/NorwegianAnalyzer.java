 ...
 * </p>
 * <p>
 * <a href="NorwegianAnalyzer.java.html"><i>View Source</i></a>
 * </p>
 * <p/>
 *
...
public final class NorwegianAnalyzer extends Analyzer {
	...
	private String NORWEGIAN_STOP_WORDS[] = { "og", "i", "er", "det", "som", "" + SYMBOL_A_RING, "til",
			"p" + SYMBOL_A_RING, "for", "av", "at", "med", "har", "en", "om", "du", "de", "ikke", "no", "vi", "jeg",
			"kan", "den", "eller", "seg", "men", "et", "dei", "skal", "ein", "blir", "s" + SYMBOL_A_RING, "vil", "fra",
			"var", "alle", "andre", "dette", "hva", SYMBOL_A_RING + "r", "bla" };

	/**
	 * Creates new instance of SpanishAnalyzer
	 */
	public NorwegianAnalyzer() {
		analyzer = new SnowballAnalyzer(Version.LUCENE_36, "Norwegian", NORWEGIAN_STOP_WORDS);
	}

	public NorwegianAnalyzer(String stopWords[]) {
		analyzer = new SnowballAnalyzer(Version.LUCENE_36, "Norwegian", stopWords);
	}
