...
public class FieldUtil {
	...
	public static void setMimeType(Document doc, String mimeType) {
		if (!Util.isEmpty(mimeType))
			doc.add(FieldUtil.UnIndexed("mime-type", mimeType));
	}
